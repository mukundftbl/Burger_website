       ...
       <Container>
         <Row>
           <Col lg={{ span: 8, offset: 2 }} className="text-center">
             <h2>Ther Burger tastes better when you eat it with your family</h2>
             <p>
               Comfort begins with smooth flow and firm direction. Enhanced
               growth and vibrant life come with strong support and structure,
               bringing top value and harmony from the start.
             </p>
