          ...
          <Carousel>
            <Carousel.Item>
              <Carousel.Caption>
                ...
                <p>
                  “From Grill to Greatness: The Secret Behind Our Juicy
                  Patties”.
                </p>
            ...
            <Carousel.Item>
              <Carousel.Caption>
                ...
                <p>
                  “Battle of the Burgers: Chicken vs. Beef — Which Reigns
                  Supreme? ”
                </p>
                <div className="item_rating mb-2">
                  <i className="bi bi-star-fill"></i>
            ...
            <Carousel.Item>
              <Carousel.Caption>
                ...
                <p>
                  “Vegan and Proud: How Plant-Based Burgers Took Over Our Menu”
                </p>
                <div className="item_rating mb-2">
                  <i className="bi bi-star-fill"></i>
                  <i className="bi bi-star-fill"></i>
            ...
            <Carousel.Item>
              <Carousel.Caption>
                ...
                <p>
                  “Vegan Smash Burger – plant-based, flavor-full, guilt-free”
                </p>
                <div className="item_rating mb-2">
                  <i className="bi bi-star-fill"></i>
                  <i className="bi bi-star-fill"></i>
